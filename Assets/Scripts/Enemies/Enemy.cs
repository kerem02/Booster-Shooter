...
public class Enemy : MonoBehaviour
{
    ...
    private float attackRange = 16.0f;
    ...
    private void Start()
    {
        if (followTarget == null && GameManager.instance != null && GameManager.instance.player != null)
        {
    ...
    {
        float distanceToTarget = followTarget != null ? Vector3.Distance(followTarget.position, transform.position) : Mathf.Infinity;
