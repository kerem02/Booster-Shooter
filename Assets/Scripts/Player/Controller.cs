...
public class Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.F) && Time.time >= nextBoostTime && !isBoosting)
        {
    ...
    private IEnumerator Boost()
    {
        ...
        {
            StartCoroutine(CameraShake.instance.Shake(boostDuration, 0.2f));
        }
        ...
        if (myRigidbody != null)
        {
            myRigidbody.linearVelocity *= 0.5f;
        }
